import {CategorizationResponse, TransactionResponse} from "../Contracts/Responses.ts";
...
export default function Amounter({transaction, categorization, onUpdated}: AmounterProps) {
    ...
    return (
        <input className="bg-[inherit] focus:bg-gray-200 w-full h-full text-right"
               value={rawAmount}
               autoFocus
               onKeyDown={keyDown}
               onInput={input}
