...
export default function SortableHeaderCell(
  props: PropsWithChildren<SortableHeaderCellProps>,
) {
  ...
  return (
    <td className={props.className}>
      <button
        className="w-full pr-1 flex justify-between items-baseline"
        onClick={cycleDirection}
      >
        {props.children}
        <div className="w-4">
          {ctx?.options.field === props.field &&
            ctx?.options.direction === "up" && (
