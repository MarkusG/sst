...
namespace Sst.Database.Migrations
{
    ...
    [Migration("20241001041445_AddCategories")]
            ...
            modelBuilder.Entity("Sst.Database.Entities.CategoryMonthTotal", b =>
                {
                    ...
                    b.ToSqlQuery("select \"Category\", extract(year from \"Timestamp\") as \"Year\", extract(month from \"Timestamp\") as \"Month\", sum(\"Transactions\".\"Amount\") as \"Total\" from \"Transactions\"\nwhere \"Transactions\".\"Category\" is not null\ngroup by \"Category\", extract(year from \"Timestamp\"), extract(month from \"Timestamp\")");
                });
